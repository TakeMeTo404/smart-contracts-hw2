...
contract RockPaperScissors {
    ...
    function getEncodeData(Choice choice, bytes32 blindingFactor) public view returns(bytes memory) {
        return abi.encodePacked(msg.sender, choice, blindingFactor);
    }

    function getKeccak256(Choice choice, bytes32 blindingFactor) public view returns(bytes32) {
        return keccak256(abi.encodePacked(msg.sender, choice, blindingFactor));
    }
